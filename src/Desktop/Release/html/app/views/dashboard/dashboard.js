...
app.controller('DashboardCtrl', function ($scope, $stateParams, $state, AccountsService, ReportsService) {
    ...
    function loadChart() {
        ...
        ReportsService.getGetMonthlyCashFlow(accountID)
        ...
        ReportsService.getRunningBalance(accountID)
            .success(function (response) {
